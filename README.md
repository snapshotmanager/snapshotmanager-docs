# Snapshot Manager Documentation

A repository for various kinds of Snapshot Manager Documentation.
...
```
$ git clone https://github.com/snapshotmanager/snapshotmanager-docs
 [ ... ]

$ cd snapshotmanager-docs
```
...
Any content inside the `static/` directory (*not* `content/static/`) will be copied into the built site verbatim. For example, `static/imgs/snapm-logo-large-1536x1536.png` -> `public/imgs/snapm-logo-large-1536x1536.png`.
